...
function repeatString(str, num) {
  ...
  let result = "";
  for (let i = 0; i < num; i++) {
    result += str; // 반복해서 문자열을 더함
  }
  console.log("6번 :", result); // 최종 결과 출력
}
...
// 10. 배열을 매개변수로 받아 배열의 모든 숫자의 합과 평균을 JS객체 형태로 반환하는 
// 함수를 선언 및 정의하고 호출하시오
...
// 12. 1. 사람의 이름과 2. 인사말을 출력하는 함수를 매개변수로 받아, 
