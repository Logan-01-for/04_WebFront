...
-> DOM 변경과 무관
-> getElementsByName(), querySelectotAll()
*/
...
function nameTest(){
  ...
  for(let i = 0; i < hobbyList.length; i ++){
    ...
    // input 요소. checked = false; -> 해당요소를 체크 해제 하겠다.
...
function cssTest(){
  ...
  // 첫번째 자식 div 접근해서
  // 내용을 "CSS 선택자로 선택해서 값 변경됨" 변경 해보기
...
function readValue(){
  ...
  // 현재 스크롤 자동으로 내려가게 하는 것
  bg.scrollTop = bg.scrollHeight
  // bg.scrollTop : 현재 스코롤 위치
